...
#define CONFIG_CPU_BALANCE_RX_THREAD
#ifdef CONFIG_CPU_BALANCE_RX_THREAD
#define CPUID_RECV 1
#endif /* CONFIG_CPU_BALANCE_RX_THREAD */
...
#define CONFIG_CPU_BALANCE_TX_THREAD
#ifdef CONFIG_CPU_BALANCE_TX_THREAD
#define CPUID_XMIT 2
#endif /* CONFIG_CPU_BALANCE_TX_THREAD */
...
#define CONFIG_CPU_BALANCE_HALXT_THREAD
#ifdef CONFIG_CPU_BALANCE_HALXT_THREAD
#define CPUID_HALXT 3
#endif /* CONFIG_CPU_BALANCE_HALXT_THREAD */
#endif
