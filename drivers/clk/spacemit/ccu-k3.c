...
CCU_FACTOR_GATE_FLAGS_DEFINE(pll6_d3, CCU_PARENT_HW(pll6), APBS_PLL6_SWCR2, BIT(2),
			     3, 1, CLK_IS_CRITICAL);
...
CCU_FACTOR_GATE_FLAGS_DEFINE(pll1_d24_102p4, CCU_PARENT_HW(pll1_d8), MPMU_ACGR,
			     BIT(12), 3, 1, CLK_IS_CRITICAL);
CCU_FACTOR_GATE_FLAGS_DEFINE(pll1_d48_51p2, CCU_PARENT_HW(pll1_d8), MPMU_ACGR,
			     BIT(7), 6, 1, CLK_IS_CRITICAL);
CCU_FACTOR_GATE_FLAGS_DEFINE(pll1_d48_51p2_ap, CCU_PARENT_HW(pll1_d8), MPMU_ACGR,
			     BIT(11), 6, 1, CLK_IS_CRITICAL);
CCU_FACTOR_GATE_DEFINE(pll1_m3d128_57p6, CCU_PARENT_HW(pll1_d8), MPMU_ACGR, BIT(8), 16, 3);
CCU_FACTOR_GATE_FLAGS_DEFINE(pll1_d96_25p6, CCU_PARENT_HW(pll1_d8), MPMU_ACGR,
			     BIT(4), 12, 1, CLK_IS_CRITICAL);
...
CCU_MUX_DIV_FC_DEFINE(axi_clk, axi_clk_parents, APMU_ACLK_CLK_CTRL, 1, 2, BIT(4),
		      0, 1, CLK_IS_CRITICAL);
...
CCU_MUX_GATE_FC_DEFINE(cci550_clk, cci550_clk_parents, APMU_CCI550_CLK_CTRL,
		       BIT(12), 0, 3, BIT(13), CLK_IS_CRITICAL);
...
CCU_MUX_DIV_GATE_SPLIT_FC_DEFINE(dsi4ln2_lcd_mclk, dsi4ln2_lcd_mclk_parents,
				 APMU_LCD_CLK_RES_CTRL4, APMU_LCD_CLK_RES_CTRL3,
...
CCU_GATE_DEFINE(pciea_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_A,
		BIT(1) | BIT(0), 0);
CCU_GATE_DEFINE(pcieb_mstr_clk, CCU_PARENT_HW(axi_clk), APMU_PCIE_CLK_RES_CTRL_B, BIT(2), 0);
CCU_GATE_DEFINE(pcieb_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_B,
		BIT(1) | BIT(0), 0);
CCU_GATE_DEFINE(pciec_mstr_clk, CCU_PARENT_HW(axi_clk), APMU_PCIE_CLK_RES_CTRL_C, BIT(2), 0);
CCU_GATE_DEFINE(pciec_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_C,
		BIT(1) | BIT(0), 0);
CCU_GATE_DEFINE(pcied_mstr_clk, CCU_PARENT_HW(axi_clk), APMU_PCIE_CLK_RES_CTRL_D, BIT(2), 0);
CCU_GATE_DEFINE(pcied_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_D,
		BIT(1) | BIT(0), 0);
CCU_GATE_DEFINE(pciee_mstr_clk, CCU_PARENT_HW(axi_clk), APMU_PCIE_CLK_RES_CTRL_E, BIT(2), 0);
CCU_GATE_DEFINE(pciee_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_E,
		BIT(1) | BIT(0), 0);
...
CCU_GATE_DEFINE(ruart_14_src, CCU_PARENT_HW(pll1_d5_491p52),
		RCPU_UART_NM_CLK_14M_CTRL, BIT(31), 0);
CCU_DDN_DEFINE(ruart_14, ruart_14_src, RCPU_UART_NM_CLK_14M_CTRL, 0, 13, 16, 13, 2, 0);
CCU_GATE_DEFINE(ruart_58_src, CCU_PARENT_HW(pll1_d5_491p52),
		RCPU_UART_NM_CLK_58M_CTRL, BIT(31), 0);
