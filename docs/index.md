...
目前 RVCK 基于统计起始点 `v6.6.127`，已累计合入 1182 个补丁（截至 2026-03-04），其中，阿里达摩院 289 个提交 (24.5%)，中兴通讯 256 个提交 (21.7%)，软件所 252 个提交 (21.3%)，进迭时空 134 个提交 (11.3%)，算能 98 个提交 (8.3%)，超睿科技 85 个提交 (7.2%)。
